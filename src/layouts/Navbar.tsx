        ...
        <>
            <header className="text-gray-600 body-font">
                <div className="container mx-auto flex flex-wrap px-5 md:py-4 flex-col md:flex-row items-center">
                    ...
                    <a className="btn btn-primary px-3 py-1 position-relative" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
                        <i className="bi bi-bag-check fs-4"></i>
                        <span className='position-absolute top-0 end-0 fw-bold  px-2 bg-danger rounded-circle'>{products.length}</span>
                    </a>
                </div>
            </header>
