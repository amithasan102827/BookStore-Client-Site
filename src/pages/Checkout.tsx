                    ...
                    <div className="col-md-5 ">
                        ...
                        <div className='border py-5 rounded shadow-md h-24 min-h-full w-4/5'>
                            ...
                            <div className='px-4 mt-5'>
                                <h3 className='fs-6 fw-semibold mb-2 text-muted'>Subtotal: ${total.toFixed(2)}</h3>
                                <h3 className='fs-6 fw-semibold mb-2 text-muted'>Delivery: $3.75</h3>
                                <h3 className='fs-6 fw-semibold mb-3'>Total: ${(total+3.75).toFixed(2)}</h3>

                                <Button className='bg-primary text-white w-100' variant="">Checkout</Button>
                            </div>
                        </div>
