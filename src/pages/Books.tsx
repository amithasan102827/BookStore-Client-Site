            ...
            <form className="w-75 mx-auto mb-5">
                <div className="mb-3">
                    <input
                        ...
                        className="form-control py-3 bg-secondary-subtle text-dark fw-semibold"
                    />
                </div>
            </form>
                        ...
                        <div key={book._id} className="lg:w-1/4 md:w-1/2 p-4 w-full">
                            ...
                            <div className="mt-4">
                                ...
                                <button
                                    ...
                                    type="button"
                                    className="bg-danger px-2 text-white fs-6 py-0 d-inline py-1 mt-1"
                                >
                                    Add To Cart<i className="bi bi-bag-plus ms-2"></i>
                                </button>
                            </div>
                        </div>
                    ))}
